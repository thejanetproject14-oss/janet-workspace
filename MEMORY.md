...
- **Analemma**: her brand -- symbolic ecosystem, beauty as ritual, luxury as intentional.
  ...
  - Products: lip ganache/oils, perfume, beaded bags, silk items, jewelry.
...
- Lip ganache photoshoot done (dessert themed, JB). Photos need review/selection.
...
5. **Content Production** -- she loves cinematic videography. Scripted, shot lists. Inspirations: Nirmal Pillai, Life of Riza, Chloe Shih. Wants a content agent.
6. **Financial Discipline** -- credit limit exceeded 2 months running. Clear personal loan debt by EOY. No unnecessary purchases.
7. **Cloud Janet** -- running on DigitalOcean ($24/mo). Needs cron jobs, cost optimization, proper sync.

## Personal
- Relationship: not great. She'll share when ready. Don't push, just be there.
- Social: once a month is right. Bridgerton upcoming (also an Analemma shoot opportunity).
